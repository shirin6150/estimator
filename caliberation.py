...
calib_data_path = r"C:\Users\shiri\OneDrive\Documents\VS Code\testing\calib_data"
...
image_dir_path = r"C:\Users\shiri\OneDrive\Documents\VS Code\testing\image"
...
np.savez(
    f"{calib_data_path}/MultiMatrix_2",
    camMatrix=mtx,
    distCoef=dist,
    rVector=rvecs,
    tVector=tvecs,
...
data = np.load(f"{calib_data_path}/MultiMatrix_2.npz")
